...
clear; rm -rf .db corpora; yarn dev && yarn start khabarfoori -u https://www.khabarfoori.com/fa/tiny/news-3035126
clear; rm -rf .db corpora; yarn dev && yarn start khabarfoori -u https://www.khabarfoori.com/fa/tiny/news-3009509
...
clear; rm -rf .db corpora; yarn dev && yarn start kayhan -u https://kayhan.ir/fa/news/275631/6-فرمانده-بزرگ-حماس-که-به-کابوس-اسرائیل-تبدیل-شده%E2%80%8Cاند
clear; rm -rf .db corpora; yarn dev && yarn start kayhan -u https://kayhan.ir/fa/news/275653/عملیات-زمینی-سقوط-اسرائیل-به-جهنم-یادداشت-روز

clear; rm -rf .db corpora; yarn dev && yarn start basijnews -u https://basijnews.ir/fa/news/9548844/کادرسازی-برای-نظام-سلامت-یک-ضرورت-است-شکست-رژیم-صهیونیستی-باجنایت-علیه-مردم-مظلوم-غزه-جبران-نمی%E2%80%8C
clear; rm -rf .db corpora; yarn dev && yarn start basijnews -u https://basijnews.ir/fa/news/9513681/بازدید-حجت-الاسلام-رضایی-از-دفتر-مرکزی-خبرگزاری-بسیج

clear; rm -rf .db corpora; yarn dev && yarn start shahraranews -u https://shahraranews.ir/fa/news/190537/افتتاح-بوستان-بانوان-شهربانوی-کوهسنگی-%7C-شهردار-مشهد-مقدس-توسعه-حاشیه-شهر-و-مسائل-بانوان-اولویت-ما-در-مدیریت-شهری-است-فیلم
clear; rm -rf .db corpora; yarn dev && yarn start shahraranews -u https://shahraranews.ir/fa/news/190294/آئین-شکرانه-خدمت-ستاد-اربعین-و-دهه-آخر-صفر-شهرداری-مشهد-مقدس

clear; rm -rf .db corpora; yarn dev && yarn start rasanews -u https://rasanews.ir/fa/news/744362/از-آغاز-فرایند-تبلیغ-در-فضای-مجازی-تا-لزوم-تدوین-دانش-نامه-تبلیغ
clear; rm -rf .db corpora; yarn dev && yarn start rasanews -u https://rasanews.ir/fa/news/744365/مجموعه-عکس-%7C-مرگ-و-نا%E2%80%8Cامنی-برای-اشغالگران-دستاورد-بزرگ-طوفان-الاقصی-۱

clear; rm -rf .db corpora; yarn dev && yarn start didarnews -u https://www.didarnews.ir/fa/news/157574/وزیر-اقتصاد-درباره-برکناری-سلاح%E2%80%8Cورزی-زمان-می%E2%80%8Cبرد-تا-همه-امضا-کنند
clear; rm -rf .db corpora; yarn dev && yarn start didarnews -u https://www.didarnews.ir/fa/news/141497/روز-برفی-در-تهران-گزارش-تصویری
...
clear; rm -rf .db corpora; yarn dev && yarn start javanonline -u https://www.javanonline.ir/fa/news/637521/حسين-علاء-درآئينه-تصاوير
clear; rm -rf .db corpora; yarn dev && yarn start javanonline -u https://www.javanonline.ir/fa/news/1192968/قاتل-در-باغ-مهرجویی-بود
...
clear; rm -rf .db corpora; yarn dev && yarn start tebyan -u https://article.tebyan.net/483979
clear; rm -rf .db corpora; yarn dev && yarn start tebyan -u https://image.tebyan.net/Image/428718/


clear; rm -rf .db corpora; yarn dev && yarn start digikala -u https://www.digikala.com/mag/laptop-buying-guide-part1-1400-12/
clear; rm -rf .db corpora; yarn dev && yarn start digikala -u https://www.digikala.com/mag/mcu-phase-5-hulk-brawn-stronger-theory/
...
clear; rm -rf .db corpora; yarn dev && yarn start barnamenevis -u "https://barnamenevis.org/showthread.php?576361-آپدیت-کردن-جدول-براساس-تکرار-داده-هر-محصول-و-نمایش-آخرین-رکورد-هر-محصول&p=2461803#post2461803"
clear; rm -rf .db corpora; yarn dev && yarn start barnamenevis -u "https://barnamenevis.org/showthread.php?329827-به-منظور-ایجاد-شماره-فاکتور-و-کد-رهگیری-الکترونیکی-برای-محصولات-فروشگاه-باید-از-چه-اصولی-پیروی-کنم؟"

clear; rm -rf .db corpora; yarn dev && yarn start p30world -u "https://forum.p30world.com/showthread.php?t=588429&page=2"
clear; rm -rf .db corpora; yarn dev && yarn start p30world -u "https://forum.p30world.com/showthread.php?t=588429"

clear; rm -rf .db corpora; yarn dev && yarn start tarfandestan -u "https://www.tarfandestan.com/forum/thread191867.html#post936725"
clear; rm -rf .db corpora; yarn dev && yarn start tarfandestan -u "https://www.tarfandestan.com/forum/thread20569-2.html"
...
clear; rm -rf .db corpora; yarn dev && yarn start persiantools -u https://forum.persiantools.com/threads/درخواست-معرفی-سیستم-همکاری-در-فروش-خوب.995911/
clear; rm -rf .db corpora; yarn dev && yarn start persiantools -u https://forum.persiantools.com/threads/نام-دامنه.996518/#post-13197302

clear; rm -rf .db corpora; yarn dev && yarn start majidonline -u https://forum.majidonline.com/threads/unreal-engine.219617/
clear; rm -rf .db corpora; yarn dev && yarn start majidonline -u https://forum.majidonline.com/threads/201318

clear; rm -rf .db corpora; yarn dev && yarn start lioncomputer -u https://forum.lioncomputer.com/topic/131247-مشاوره-خريد-مودم-مبين-نت/
clear; rm -rf .db corpora; yarn dev && yarn start lioncomputer -u https://forum.lioncomputer.com/topic/131247-مشاوره-خريد-مودم-مبين-نت/page/2/

clear; rm -rf .db corpora; yarn dev && yarn start yekpezeshk -u https://www.1pezeshk.com/archives/2023/06/joan-is-awful.html
clear; rm -rf .db corpora; yarn dev && yarn start yekpezeshk -u https://www.1pezeshk.com/archives/2023/10/from-here-to-eternity-1953.html

clear; rm -rf .db corpora; yarn dev && yarn start digiato -u https://digiato.com/artificial-intelligence/us-intelligence-ai-bots
clear; rm -rf .db corpora; yarn dev && yarn start digiato -u https://digiato.com/energy/australia-made-a-breakthrough-in-generating-solar-power
...
clear; rm -rf .db corpora; yarn dev && yarn start namnak -u https://namnak.com/parenting-teen-tips.p91098
clear; rm -rf .db corpora; yarn dev && yarn start namnak -u https://namnak.com/matthew-perry-biography.p91129

clear; rm -rf .db corpora; yarn dev && yarn start beytoote -u https://www.beytoote.com/pictures/news-photos/mbnews1879.html
clear; rm -rf .db corpora; yarn dev && yarn start beytoote -u https://www.beytoote.com/news/scientific-news/best2-price-xiaomiphone.html
...
clear; rm -rf .db corpora; yarn dev && yarn start sid -u https://www.sid.ir/blog/post/82121/استفاده-مرکز-اطلاعات-علمی-جهاددانشگاهی-از-ظرفیت-های-داده-کاوی-و-هوش-مصنوعی
clear; rm -rf .db corpora; yarn dev && yarn start sid -u https://www.sid.ir/blog/post/82243/بهترین-مترجم-هوش-مصنوعی

clear; rm -rf .db corpora; yarn dev && yarn start sakhtafzarmag -u https://forums.sakhtafzarmag.com/threads/26886-تاپیک-تبریک-سال-نو-1402-به-کاربران-انجمن-سخت-افزار-مگ?p=242264#post242264
clear; rm -rf .db corpora; yarn dev && yarn start sakhtafzarmag -u https://forums.sakhtafzarmag.com/threads/3642-برترین-نشریه-it-ایران-را-انتخاب-کنید?p=238704#post238704

clear; rm -rf .db corpora; yarn dev && yarn start bazicenter -u https://forum.bazicenter.com/threads/اخبار-مربوط-به-کیفیت-اجرایی-بازی-ها-قوانین-پست-اول-خوانده-شود.86656/
clear; rm -rf .db corpora; yarn dev && yarn start bazicenter -u https://forum.bazicenter.com/threads/اخبار-مربوط-به-کیفیت-اجرایی-بازی-ها-قوانین-پست-اول-خوانده-شود.86656/page-2

clear; rm -rf .db corpora; yarn dev && yarn start wppersian -u https://forum.wp-persian.com/topic/642
clear; rm -rf .db corpora; yarn dev && yarn start wppersian -u https://forum.wp-persian.com/topic/536

clear; rm -rf .db corpora; yarn dev && yarn start joomlafarsi -u https://forum.joomlafarsi.com/threads/64066-نیاز-به-فایل-های-زبان-فارسی-برای-EasyArticles-و-Komento?p=293247#post293247
clear; rm -rf .db corpora; yarn dev && yarn start joomlafarsi -u https://forum.joomlafarsi.com/threads/64041-درخواست-ماژول-یا-کامپوننت-گالری?p=293207#post293207

clear; rm -rf .db corpora; yarn dev && yarn start moshaver -u https://forum.moshaver.co/f124/مهارت%20آینده%20نگری%20هوشمندانه-56738/#post319523
clear; rm -rf .db corpora; yarn dev && yarn start moshaver -u https://forum.moshaver.co/f30/کنکور%20ارشد%20ر.بالینی-48789/
...
clear; rm -rf .db corpora; yarn dev && yarn start sheypoor -u https://blog.sheypoor.com/cars-with-m15-engine/
clear; rm -rf .db corpora; yarn dev && yarn start sheypoor -u https://blog.sheypoor.com/buying-cars-from-100-to-300-million/

clear; rm -rf .db corpora; yarn dev && yarn start divar -u https://divar.ir/v/آپارتمان-۲خواب-فول-امکانات-پروژه-ارغوان/QZaCe9yK
...
yarn dev && yarn start pishgamfanavari
